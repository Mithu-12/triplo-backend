...
router.post('/payment-process/:paymentOption', async (req, res) => {
  ...
  try {
    ...
    const data = {
      ...
      success_url: `http://localhost:8800/api/payment/success/${tran_id}`,
      fail_url: `http://localhost:8800/api/payment/failed/${tran_id}`,
      cancel_url: `http://localhost:8800/api/payment/cancel/${tran_id}`,
