...
router.post('/payment-process/:paymentOption', async (req, res) => {
  ...
  try {
    const data = {
      ...
      success_url: `https://triplo.cyclic.app/api/payment/success/${tran_id}`,
      fail_url: `https://triplo.cyclic.app/api/payment/failed/${tran_id}`,
      cancel_url: `https://triplo.cyclic.app/api/payment/cancel/${tran_id}`,
